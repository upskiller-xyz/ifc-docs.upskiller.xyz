...
Coordinate values use the XYZ coordinate system with Z pointing up. See [Coordinate System](/contributing/coordinate-system) for details.
...
<svg viewBox="0 0 24 24" style={{height: '1em', width: '1em', fill: 'none', stroke: 'currentColor', strokeWidth: '2', strokeLinecap: 'round', strokeLinejoin: 'round', verticalAlign: '-0.125em', marginRight: '0.4em'}}><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg> [How to measure](/ifc-daylight-factor/methodology/parameters#room-geometry)
...
<svg viewBox="0 0 24 24" style={{height: '1em', width: '1em', fill: 'none', stroke: 'currentColor', strokeWidth: '2', strokeLinecap: 'round', strokeLinejoin: 'round', verticalAlign: '-0.125em', marginRight: '0.4em'}}><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg> [How to measure](/ifc-daylight-factor/methodology/parameters#window-geometry) | [Coordinate System](/contributing/coordinate-system)
...
<svg viewBox="0 0 24 24" style={{height: '1em', width: '1em', fill: 'none', stroke: 'currentColor', strokeWidth: '2', strokeLinecap: 'round', strokeLinejoin: 'round', verticalAlign: '-0.125em', marginRight: '0.4em'}}><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg> [How to measure](/ifc-daylight-factor/methodology/parameters#context-obstruction) | [Coordinate System](/contributing/coordinate-system) | [Direction Angles](/contributing/coordinate-system#single-angle-direction-system)
...
<svg viewBox="0 0 24 24" style={{height: '1em', width: '1em', fill: 'none', stroke: 'currentColor', strokeWidth: '2', strokeLinecap: 'round', strokeLinejoin: 'round', verticalAlign: '-0.125em', marginRight: '0.4em'}}><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg> [How to measure](/ifc-daylight-factor/methodology/parameters#reflectance)

---

## Still unclear?

Check [parameter explanation](/ifc-daylight-factor/methodology/parameters) for more details about each parameter.
