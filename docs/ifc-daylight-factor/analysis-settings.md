...
The **Analysis Settings** panel (left side, below the toolbar) sets the assumptions used for every simulation. Review it before running an analysis. When you change a value, the current result recalculates.

<img src="https://upskiller-website.s3.fr-par.scw.cloud/docs.ifc/analysis-settings.png" alt="Analysis Settings panel" width="285" />
